...
urlpatterns = [
    ...
    url(r'^instructor_course_intro/(?P<course>[\w{}\.\-\/]{1,40})/$','SIP.views.display_instructor_intro', name='display_instructor_intro' ),
    ...
    url(r'^facultyuploaderinfo/(?P<courseid>[\w{}\.\-\/]{1,40})/$','SIP.views.facultyuploaderinfo',name='facultyuploaderinfo'),
   ...
   #url(r'^courseallteachers$','SIP.views.courseallteachers',name='courseallteachers'),
   url(r'^courseallevaluationdata/(?P<courseid>[\w{}\.\-\/]{1,40})/$','SIP.views.courseallevaluationdata',name='evaluation'),
   url(r'^facultyallstudentinfo/(?P<courseid>[\w{}\.\-\/]{1,40})/$','SIP.views.facultyallstudentinfo',name='facultyallstudentinfo'),
   url(r'^invited_userlist/(?P<courseflag>[0-9])/$','SIP.views.invited_userlist',name='invited_userlist'),
   url(r'^userweeklysession/$', 'SIP.views.userweeklysession',name='userweeklysession'),
 ]
